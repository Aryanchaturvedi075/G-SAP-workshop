...
const GsapTimeline = () => {
  ...
  useGSAP(() => {
    timeline.to("#yellow-box", { x:250, rotation: 360, borderRadius: '50%'});
    timeline.to("#yellow-box", { y:250, rotation: 720, borderRadius: '10%', scale: 2});
    timeline.to("#yellow-box", { x:0, y:0, rotation: 0, borderRadius: '50%', scale: 1});
  }, []);
